...
const UserProfile = () => {
    ...
    useEffect(() => {
        ...
        const fetchUserProfile = async () => {
            try {
                const response = await axios.get(`https://chat-app-mkfi.onrender.com/api/auth/profile/${userId}`, config);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.put(`https://chat-app-mkfi.onrender.com/api/auth/profile/${userId}`, formData, config);
            setUserProfile(response.data);
            ...
            <StyledPaper elevation={3}>
                <Grid container spacing={4} justifyContent="center">
                    <Grid item xs={12} md={6}>
                        <StyledAvatar
                            src={previewUrl || (userProfile.avatar ? `https://chat-app-mkfi.onrender.com${userProfile.avatar}` : null)}
